...
namespace BillingApp.Controllers
{
    public class AdminsController : Controller
    {
        ...
        {
            var billingDbContext = _context.Admins.Include(a => a.User);
        ...
        public async Task<IActionResult> Create([Bind("AdminId,UserId")] Admin admin)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.AppUsers, "UserId", "FullName", admin.UserId);
            return View(admin);
        }
        ...
        {
            return View("~/Views/Admins/AdminDashboard.cshtml"); // Ensure correct path
        }
